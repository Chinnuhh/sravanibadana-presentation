...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sravani BadanaPresentation" },
      { name: "description", content: "Donor Growth Journey manages donor lifecycles, re-engaging lapsed donors and segmenting high-value donors." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Sravani BadanaPresentation" },
      { property: "og:description", content: "Donor Growth Journey manages donor lifecycles, re-engaging lapsed donors and segmenting high-value donors." },
